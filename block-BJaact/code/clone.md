...
//Because we are copying person to person2, they refer to same object.
```
...
// person and personTwo refers to two different objects which are pointing to the same address array. Spread operator does the  shallow cloning so it dosen't clone the address array.
```
